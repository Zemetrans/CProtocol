...
public interface BasicInterface {
     ...
     */
    @BusMethod
    int getSensorsCount() throws BusException;

    @BusMethod
    int getTemp(int num) throws BusException;

    @BusMethod
    String getName(int num) throws BusException;

    @BusMethod
    int lightOff() throws BusException;
}
